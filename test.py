...
# ======================
MATRIX_BG = "#050505"  # Slightly off-black for depth
MATRIX_GREEN = "#00FF00"  # Bright neon green for high visibility
DARK_GREEN = "#005500"  # Richer dark green for contrast
ACCENT_GREEN = "#00AA00"  # Balanced accent green for highlights
...
class IDSDashboard:
    def __init__(self, root):
        ...
        # Initialize the current_view and views attributes
    ...
    def show_view(self, view_name):
        ...
        if view_name not in self.views:
            ...
            if view_name == "Dashboard":
                self.views[view_name] = ttk.Label(self.container, text="Dashboard View", font=("Consolas", 16))
            elif view_name == "TrafficAnalysis":
                self.views[view_name] = TrafficAnalysisView(self.container)
            elif view_name == "ThreatAlerts":
                self.views[view_name] = ttk.Label(self.container, text="Threat Alerts View", font=("Consolas", 16))
            elif view_name == "PacketStream":
                self.views[view_name] = ttk.Label(self.container, text="Packet Stream View", font=("Consolas", 16))
